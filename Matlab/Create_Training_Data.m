...
function Create_Training_Data()
    ...
    Create_Data_Sets(VOWELS, TRAINING_AUDIO_PATH, SAVE_DATA_LOCATION, ORIGINAL_SAMPLING_RATE, NUM_COEFICIENTS, Parameterization.LPC);
    disp("Done.")

    fprintf("Starting MFCC Training Data creation ...")
    Create_Data_Sets(VOWELS, TRAINING_AUDIO_PATH, SAVE_DATA_LOCATION, ORIGINAL_SAMPLING_RATE, NUM_COEFICIENTS, Parameterization.MFCC);
    disp("Done.")
end